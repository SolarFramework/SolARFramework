...
public:
	...
	virtual FrameworkReturnCode getPoint(uint32_t id, SRef<datastructure::CloudPoint>& point) = 0;
	...
	/// @return FrameworkReturnCode::_SUCCESS_ if succeed, else FrameworkReturnCode::_ERROR.
    virtual FrameworkReturnCode getPoints(const std::vector<uint32_t> &ids, std::vector<SRef<datastructure::CloudPoint>>& points) = 0;
	...
	/// @return FrameworkReturnCode::_SUCCESS_ if succeed, else FrameworkReturnCode::_ERROR.
	virtual FrameworkReturnCode getAllPoints(std::vector<SRef<datastructure::CloudPoint>>& points) = 0;
