...
public:
	...
	virtual FrameworkReturnCode getKeyframe(uint32_t id, SRef<datastructure::Keyframe>& keyframe) = 0;
	...
	/// @return FrameworkReturnCode::_SUCCESS_ if succeed, else FrameworkReturnCode::_ERROR.
	virtual FrameworkReturnCode getKeyframes(const std::vector<uint32_t> &ids, std::vector<SRef<datastructure::Keyframe>>& keyframes) = 0;

	/// @brief This method allows to get all keyframes
	/// @param[out] keyframes the set of keyframes
	/// @return FrameworkReturnCode::_SUCCESS_ if succeed, else FrameworkReturnCode::_ERROR.
	virtual FrameworkReturnCode getAllKeyframes(std::vector<SRef<datastructure::Keyframe>>& keyframes) = 0;
	...
	virtual FrameworkReturnCode setDescriptorType(datastructure::DescriptorType type) = 0;
