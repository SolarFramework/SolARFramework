 ...
 */
class XPCF_IGNORE IMarker2DNaturalImage : virtual public IMarker2DSquared {
...
public:
    ...
    virtual FrameworkReturnCode getImage(SRef<SolAR::datastructure::Image> & img) const = 0;
