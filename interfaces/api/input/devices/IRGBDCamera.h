...
public:
    ...
    virtual FrameworkReturnCode getNextRGBDFrame(SRef<datastructure::Image>& colorImg, SRef<datastructure::Image>& depthImg) = 0;
    ...
    virtual FrameworkReturnCode alignDepthToColor (SRef<datastructure::Image>& alignedDepthImg) const = 0;
    ...
    virtual FrameworkReturnCode alignColorToDepth (SRef<datastructure::Image>& alignedColorImg) const = 0;
    ...
    virtual datastructure::Point3Df getPixelToWorld (const datastructure::Point2Di& inPixel) const = 0;
    ...
    virtual datastructure::Point2Di getWorldToPixel (const datastructure::CloudPoint& in3DPoint) const = 0;
    ...
    virtual std::vector<datastructure::Point2Df> getWorldToPixels (const std::vector<datastructure::CloudPoint>& in3DPoints) const = 0;
};
