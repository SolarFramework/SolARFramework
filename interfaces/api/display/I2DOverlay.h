...
public:
	...
	virtual void drawLines(const std::vector<datastructure::Keyline> & keylines, SRef<datastructure::Image> displayImage) = 0;
	...
	/// @param[in,out] displayImage The image on which the lines will be drawn.
	virtual void drawLines(const std::vector<datastructure::Edge2Df> & ln2d, SRef<datastructure::Image> displayImage) = 0;
