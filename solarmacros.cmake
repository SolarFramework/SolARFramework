...
macro (process3rdParty THIRDPARTY THIRDPARTY_PATH)
	...
	foreach( library ${LIBS_LIST} )
		set (LINK_LIBRARIES_RELEASE "optimized ${THIRDPARTY_LIB_DIR_RELEASE}/${LINKLIBPREFIX}${library}${LINKLIBEXTENSION} ${LINK_LIBRARIES_RELEASE} ${LINKER_OPTIONS}")
		set (LINK_LIBRARIES_DEBUG "debug ${THIRDPARTY_LIB_DIR_DEBUG}/${LINKLIBPREFIX}${library}${LINKLIBEXTENSION} ${LINK_LIBRARIES_DEBUG} ${LINKER_OPTIONS}")
	endforeach(library)
