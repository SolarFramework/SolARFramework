...
macro (process3rdParty THIRDPARTY THIRDPARTY_PATH)
	...
	foreach( library ${LIBS_LIST} )
		set (LINK_LIBRARIES_RELEASE "${THIRDPARTY_LIB_DIR_RELEASE}/${LINKLIBPREFIX}${library}${LINKLIBEXTENSION} ${LINK_LIBRARIES_RELEASE}")
		set (LINK_LIBRARIES_DEBUG "${THIRDPARTY_LIB_DIR_DEBUG}/${LINKLIBPREFIX}${library}${LINKLIBEXTENSION} ${LINK_LIBRARIES_DEBUG}")
	endforeach(library)
