...
macro (processPackagedependencies)
	...
	foreach(file ${files})
	  ...
	  message (STATUS "##### ${PKGNAME_UP}_VERSION version is ${${PKGNAME_UP}_VERSION} in ${PKGBUILDMODE} mode")
	  process3rdParty("${PKGNAME}" ${PKGPATH} ${PKGBUILDMODE})
	endforeach(file)
