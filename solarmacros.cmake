...
if (UNIX)
	...
	set (LINKER_OPTIONS_RELEASE "optimized dl")
	set (LINKER_OPTIONS_DEBUG "debug dl")
endif(UNIX)
...
macro (processPackagedependencies)
	...
	set (LINK_LIBRARIES_RELEASE "${LINKER_OPTIONS}")
	set (LINK_LIBRARIES_DEBUG "${LINKER_OPTIONS}")	
	foreach(file ${files})
